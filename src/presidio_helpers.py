...
from src.openai_fake_data_generator import (
    call_completion_model,
    OpenAIParams,
    create_prompt,
)
from src.presidio_nlp_engine_config import (
...
def nlp_engine_and_registry(
    ...
    elif 'openai' in model_family.lower():
        return create_nlp_engine_with_llm(model_path)
    else:
